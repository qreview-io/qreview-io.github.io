                ...
                component = Object(o.a)(
                    ...
                    function () {
                        var e = this,
                            t = e.$createElement,
                            r = e._self._c || t;
                        return r("section", { staticClass: "about__LogoSlider" }, [
                            r(
                                "div",
                                { staticClass: "container" },
                                [
                                    r("div", { staticClass: "about__LogoSliderHeading" }, [r("h2", { domProps: { textContent: e._s(e.data.value.title) } })]),
                                    e._v(" "),
                                    r(
                                        "DragSlider",
                                        { staticClass: "about__LogoSliderWrap" },
                                        e._l(e.data.value.items, function (e) {
                                            return r("img", { directives: [{ name: "lazy-load", rawName: "v-lazy-load" }], key: e.id, attrs: { "data-not-lazy": "", "data-src": e.meta.url, alt: e.alt, width: "270", height: "113" } });
                                        }),
                                        0
                                    ),
                                    e._v(" "),
                                    null !== e.data.value.link
                                        ? r("div", { staticClass: "about__LogoButton" }, [
                                              r("a", { staticClass: "btn--White", attrs: { href: "mailto:contact@relio.ch?subject=Investor request" } }, [
                                                  e._v("\n        " + e._s(e.data.value.link.cta) + "\n        "),
                                                  r("span", [
                                                      r(
                                                          "svg",
                                                          {
